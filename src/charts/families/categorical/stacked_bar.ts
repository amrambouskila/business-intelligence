...
class StackedBarRenderer extends EChartsBaseRenderer {
...
chartRegistry.register({
  ...
  description: 'Compare category totals split into stacked subgroup contributions',
  renderer: 'echarts',
  ...
  createRenderer: () => new StackedBarRenderer(),
});
